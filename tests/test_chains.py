...
class ChainTester:
    ...
    def run_all_chain_tests(self):
        ...
        test_cases = [
            ...
            ('humana_chain_runner.sh', 'corporate_nav', 'How do I navigate a difficult meeting?'),
            ('humana_chain_runner.sh', 'innovation_discovery', 'Find automation opportunities'),
            ('humana_chain_runner.sh', 'ai_leadership', 'Position myself as AI leader'),
            ('humana_chain_runner.sh', 'solution_design', 'Design solution for manual process'),
