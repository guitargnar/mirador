...
Apply your deep understanding of Matthew's complete story - his musical collaboration experience from Annapurna's 9-year journey, pattern recognition abilities from childhood, current reality as a single father to Sage, relationship building with Katie, financial constraints ($1,650 take-home, $91K equity), and transformation from crisis to AI innovation. How do these personal experiences and constraints specifically inform the approach to this challenge?$FORMAT_INSTRUCTION"
...
Please provide your specialized perspective and detailed recommendations, ensuring they connect to Matthew's specific context and constraints.$FORMAT_INSTRUCTION"
        fi
    fi
