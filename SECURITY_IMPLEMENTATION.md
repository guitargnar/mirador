...
class SensitiveDataProtector:
    ...
    def _compile_patterns(self) -> Dict[str, re.Pattern]:
        ...
        patterns = {
            ...
            'humana_id': re.compile(r'\b(humana|employee)[\s_-]?(id|number)[\s:=]+\w+\b', re.IGNORECASE),
    ...
    def _assess_severity(self, pattern_type: str, value: str) -> str:
        ...
        medium_severity = ['salary', '401k', 'humana_id', 'email']
    ...
    def _get_redaction(self, pattern_type: str, value: str) -> str:
        ...
        redactions = {
            ...
            'humana_id': '[EMPLOYEE-ID-REDACTED]',
...
if git diff --cached --name-only | grep -q "\.gitignore"; then
    ...
    CRITICAL_PATTERNS=("*humana*" "*401k*" "*salary*" "matthew_*.json")
