...
if [ -f 'Documentation and Saved Assets/humana-manager-strategy.md' ]; then
    rm 'Documentation and Saved Assets/humana-manager-strategy.md'
    echo 'Deleted: Documentation and Saved Assets/humana-manager-strategy.md'
    ((deleted_count++))
fi
...
if [ -f 'Documentation and Saved Assets/humana-communication-msgs.md' ]; then
    rm 'Documentation and Saved Assets/humana-communication-msgs.md'
    echo 'Deleted: Documentation and Saved Assets/humana-communication-msgs.md'
    ((deleted_count++))
fi
