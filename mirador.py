...
ROLES = {
    ...
    "humana_innovation_catalyst": {
        "prompt": "Identify innovation opportunities and implementation strategies within Humana's constraints: {input}",
        "temp": 0.6
    },
...
CHAIN_TEMPLATES = {
    ...
    "innovation": ["matthew_context_provider_v3", "humana_innovation_catalyst", "solution_architect", "enhanced_agent_enforcer"],
    "ai_leadership": ["matthew_context_provider_v3", "ai_leadership_strategist", "enhanced_agent_enforcer"],
    "corporate_nav": ["matthew_context_provider_v3", "humana_politics_navigator", "enhanced_agent_enforcer"],
    "solution": ["humana_innovation_catalyst", "solution_architect", "enhanced_agent_enforcer"],
    "advocates": ["matthew_context_provider_v3", "advocates_meeting_optimizer_v2", "ai_leadership_strategist", "enhanced_agent_enforcer"],
    "quick_win": ["humana_innovation_catalyst", "solution_architect"],
    "strategic": ["matthew_context_provider_v3", "humana_innovation_catalyst", "ai_leadership_strategist", "humana_politics_navigator", "enhanced_agent_enforcer"]
}
